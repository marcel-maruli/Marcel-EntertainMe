  ...
  return (
    <div className={classes.grow}>
      <AppBar position="static" style={{ backgroundColor: '#795548' }}>
        <Toolbar>
          <img src="https://img.pngio.com/oc-cutie-mark-entertain-by-kiwiistyle-on-deviantart-entertain-png-904_884.png" className={classes.menuButton} style={{ width: "3vw" }} />
          <IconButton
            edge="start"
